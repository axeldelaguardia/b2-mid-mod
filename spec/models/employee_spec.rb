  ...
  describe 'relationships' do
	...
	describe 'instance methods' do
		...
		it '#tickets_sorted_desc' do
			expect(employee_1.tickets_sorted_desc).to eq([ticket_4, ticket_2, ticket_3, ticket_1])
		end

		it '#ticket_ids' do
			expect(employee_1.ticket_ids).to eq([ticket_1.id, ticket_2.id, ticket_3.id, ticket_4.id])
		end
	end
end